...
import { upsertLocationMetrics } from "@/features/admin/adminCollegeService";
import { locationInputSchema } from "@/features/admin/adminCollegeSchemas";
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const result = await upsertLocationMetrics(id, parsed.data);
  if (!result.success) {
